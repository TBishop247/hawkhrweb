...
export default function AppFooter() {
  ...
  return (
    ...
    <div className="container-fluid footer footer-bg mt-4">
      ...
      <div className="row">
        <div className="col text-center pt-2">
          ...
          <a href="#" className="footer-item">Artistic and Design Attribution</a>
        </div>
      </div>
      <div className="row mt-2">
        <div className="col text-center">
          ...
          <Link href="https://reddit.com/r/HawkHR" target="_blank" title="Open Reddit channel"><Image src="/reddit.png" alt="Reddit logo" height={28} width={28}  /></Link>
        </div>
      </div>
      </div>
  );
